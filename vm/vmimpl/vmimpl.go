...
type Instance interface {
	...
	// –––––––––––––––––––––––– Container Checker VM Requirements –––––––––––––––––––––––––––––
	...
	// Get comm.
	Comm(index int) comm.HostComm

	// Run command through ssh.
	RawRun(command string) (*exec.Cmd, io.WriteCloser, io.ReadCloser, io.ReadCloser, error)
...
type Env struct {
	...
	Template string
	CommNum  int
	LoadVM   bool // directly load to snapshot
}
